...
def plotly_yield_after_search_beat(stops_df,
    ...
    trace_1 = go.Scatter(x = x, y = y, text = list(range(1,17)),
                             ...
                             textfont = {'family': 'Nunito ExtraLight, Tahoma, Arial', 'size': 12},
                             hoverinfo = 'text',
                             hovertext = text,
                             hoverlabel = {'bgcolor': 'white',
                                           'font': {'family': 'Nunito ExtraLight, Tahoma, Arial', 'size': 12}},
                             showlegend = False)
...
def plotly_yield_after_search(stops_df,
    ...
    trace_3 = go.Scatter(x = x, y = [1] * len(x), name = '1:1 Ratio',
                         mode = 'lines',
                         line = dict(color = '#52679D', width = 1, dash = 'dash'),
    #                      hovertext = text,
                         hoverlabel = {'bgcolor': 'white',
                                       'font': {'family': 'Nunito ExtraLight, Tahoma, Arial', 'size': 12}},
                         showlegend = True,
    ...
    trace_4 = go.Scatter(x = x, y = [mean] * len(x), name = f'Average Ratio ({round(mean, 2)})',
                         mode = 'lines',
                         line = dict(color = '#C8113D', width = 1, dash = 'dash'),
    #                      hovertext = text,
                         hoverlabel = {'bgcolor': 'white',
                                       'font': {'family': 'Nunito ExtraLight, Tahoma, Arial', 'size': 12}},
                         showlegend = True,
    ...
    legend = go.layout.Legend(font = {'family': 'Nunito ExtraLight, Tahoma, Arial', 'size': 12},
                              bgcolor = 'rgba(250, 250, 250, 0.8)',
                              x = .99,
                              xanchor = 'right',
                              y = 0.99,
